...
//Confeccionar una ventana que contenga tres objetos de la clase JButton con las etiquetas "Pulsa o teclea 1", "Pulsa o teclea 2" y "Pulsa o teclea 3" 
//y un display de tipo JLabel. 
//Al presionarse cualquiera de los botones o pulsar en el teclado 1, 2 o 3 
//debe cambiar el texto del JLabel con los números correspondientes. Además, al pasar por encima de cada botón debe cambiar el color de fondo del mismo.
//Por último, un cuarto botón con el texto "limpiar display" (o pulsar la letra "c") debe vaciar el texto del JLabel display.

public class EjemploBoton3 extends JFrame {

	JLabel display;
	  JButton boton1, boton2, boton3, botonLimpiar;

	  public EjemploBoton3(){
